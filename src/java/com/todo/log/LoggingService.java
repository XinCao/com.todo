 ...
 * <p/>
 *
 * Default {@link org.apache.log4j.spi.LoggerFactory} can by configured by
 * system property {@value #LOGGER_FACTORY_CLASS_PROPERTY}
 * <p/>
 *
...
public class LoggingService {
     ...
     * <p/>
     *
     * Log4j uses this Hierarchy for loggers that don't have exact name match
     * and element categoryFactory for loggers with names that matches specified
     * names in log4j.xml.
     * <p/>
     *
    ...
    public void setLoggerConfigFile(String loggerConfigFile) {
        LoggingService.loggerConfigFile = loggerConfigFile;
    }
}