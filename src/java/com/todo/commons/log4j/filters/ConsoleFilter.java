 ...
 */
package com.todo.commons.log4j.filters;

import org.apache.log4j.spi.Filter;
import org.apache.log4j.spi.LoggingEvent;

/**
 * Log4J filter that looks if there is console present in the logging event and
 * accepts event if present. Otherwise it blocks filtring.
 *
 * @author Divinity
 */
public class ConsoleFilter extends Filter {
     ...
     * @return {@link org.apache.log4j.spi.Filter#DENY} if chat,
     * {@link org.apache.log4j.spi.Filter#ACCEPT} otherwise
     */
    @Override
